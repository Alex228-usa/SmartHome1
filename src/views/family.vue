...
export default {
  ...
  methods: {
    initMap () {
      ...
      this.markers.push(
        L.marker([38.60, -90.20]).bindPopup("Alikhan at work").addTo(this.map),
        L.marker([38.63, -90.23]).bindPopup("Alikhan at home.").addTo(this.map).openPopup(),
        L.marker([38.66, -90.26]).bindPopup("Alikhan at school").addTo(this.map)
      )
      this.active = 1
      this.showMe(1, 'green')
    },
